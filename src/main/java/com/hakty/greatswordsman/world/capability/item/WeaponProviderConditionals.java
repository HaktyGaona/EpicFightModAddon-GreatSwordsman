...
public final class WeaponProviderConditionals {
    ...
    public static final DeferredConditional BASTARDSWORD_1H = REGISTRY.registerConditional(
            ...
            () -> ProviderConditional.createSkillDataKey(CapabilityItem.Styles.ONE_HAND, SwordCraftSkills.BASTARDSWORD_POSTURE_CHARGE, SkillSlots.WEAPON_PASSIVE, SwordCraftSkillDataKeys.POSTURE_CHARGE_1H, false));

    public static final DeferredConditional BASTARDSWORD_2H = REGISTRY.registerConditional(
            "bastardsword_2h_wield_style",
            () -> ProviderConditional.createSkillDataKey(CapabilityItem.Styles.TWO_HAND, SwordCraftSkills.BASTARDSWORD_POSTURE_CHARGE, SkillSlots.WEAPON_PASSIVE, SwordCraftSkillDataKeys.POSTURE_CHARGE_2H, false)
    );
}
